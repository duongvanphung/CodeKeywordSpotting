...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--start_checkpoint',
      type=str,
      default='tmp/speech_commands_train/conv.ckpt-200',
  ...
  parser.add_argument(
      '--wanted_words',
      type=str,
      default='bo_ra,cuu_toi,cuu_con',
      help='Words to use (others will be added to an unknown label)',)
  parser.add_argument(
      '--output_file', type=str, default='output_model.pb', help='Where to save the frozen graph.')
  parser.add_argument(
      '--quantize',
      type=bool,
      default=False,
